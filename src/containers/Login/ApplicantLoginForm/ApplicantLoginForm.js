    ...
    return (
        <div>
            ...
            <ul style={{textAlign: 'right', listStyleType: 'none'}}>
                    <li><a style={{padding: '20px 40px 20px 40px', color: 'purple', cursor: 'pointer', textDecoration: 'underline'}} onClick={props.loginChange}>Company Login</a></li>
                </ul>
            ...
            <form className="Login" style={{backgroundColor: "#dedfe0", margin: "100px 350px 0px 350px", paddingBottom: "40px", paddingTop: "40px", boxShadow: '3px 3px 2px 0px rgba(0,0,0,0.33)'}}>
                <div>
                    <h2 style={{color: 'purple'}}>Applicant Login</h2>
                </div>
                    ...
                    <div style={{marginTop: '5px'}}>
                        <Link from='/' to='/applicant' ><a style={{backgroundColor: 'purple', color: 'white', padding: '10px', boxShadow: '2px 2px 1px 0px rgba(0,0,0,0.75)'}}>Login</a></Link>
                    </div>
                </form>
            </div>
    );
